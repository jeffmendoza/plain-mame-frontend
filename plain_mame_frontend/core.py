...
PKGSYSCONFDIR="/etc/plain-mame-frontend"
#PKGSYSCONFDIR=os.path.join(os.path.dirname(os.path.realpath(sys.argv[0])), "..", "sysconfdir")
...
class Conf:
    ...
    def __init__(self):
        ...
        config.readfp(open(os.path.join(PKGSYSCONFDIR, 'pmfe.ini')))
